...
function PageEditBlock({ order, picSize=100, textWidth=400, p=30, image, spacing=10, parentID}) {
        ...
        <div className="pageBlock">
            ...
            >
                {order === "pic" ? 
                    ...
                    <InfoEditBlock w={textWidth} h={picSize * 0.6} parentID={fid} />
                }
            </div>
            <div 
